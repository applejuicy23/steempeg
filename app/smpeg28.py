...
class FilterPillButton(QPushButton):
    def __init__(self, parent=None):
        ...
        # Elegant static design (in the style of a sorting combo box)
        self.setStyleSheet("""
...
class FilterMenu(QWidget):
    ...
    def clear_filters(self):
        """ Resets all buttons and calendars. """
...
class SteempegApp(QObject):
    ...
    def apply_sorting(self):
        ...
        # Instantly synchronize the grid without deleting images
...
class TimelineCanvas(QWidget):
    ...
    def mousePressEvent(self, event):
        ...
        if getattr(self, 'hovered_marker', None):
            if event.button() == Qt.RightButton:
                # Removed the check for usermarker! Now the menu opens for ALL markers.
    ...
    def show_marker_context_menu(self, pos, marker):
        ...
        # This button is added ABSOLUTELY EVERY TIME
        action_trim = menu.addAction("✂️ Set Trim Start Here")
        
        action = menu.exec(pos)
        
        # Handle clicks (checking if the button existed at all)
