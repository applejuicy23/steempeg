...
class SteempegApp:
    def __init__(self):
        ...
        loader = QUiLoader()
        ui_file_path = get_resource_path("smpegui11.ui")
        ...
        self.ui.setWindowTitle("Steempeg v9")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if getattr(window, 'ui', None) is None:
            QMessageBox.critical(None, "Interface Error", "Failed to load smpegui11.ui! Check if the file is located next to the script and that the name matches.")
            sys.exit(1)
