...
class SteempegApp(QObject):
    ...
    def toggle_fullscreen(self):
        ...
        if self.is_fullscreen:
            ...
            # AIRSPACE PROBLEM
            # We transform the panel into an independent, floating window
            # to ensure it is guaranteed to be drawn *on top* of MPV's
            # hardware (native) window!
           ...
           # Give the window 50ms to expand, then align the floating panel.
            ...
            # RESTORING THE PANEL TO THE STANDARD INTERFACE
            # We remove the floating window flags from it and place it back into the layout.
