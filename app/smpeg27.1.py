...
# --- GLOBAL APP VERSION ---
APP_VERSION_STR = "27.1"
APP_VERSION_FLOAT = 27.1
...
class FilterPillButton(QWidget):
    ...
    def __init__(self, parent=None):
       ...
       # Enable CSS support for QWidget and assign a fixed ID
        ...
        pix = QPixmap(get_resource_path("filter.png")).scaled(18, 18, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        ...
        if hasattr(self.ui, 'settings_tabs'):
            ...
            def update_button_state(hovering=False):
                ...
                if self.settings_collapsed:
                    ...
                    path = get_resource_path("showeye.png") if hovering else get_resource_path("hideeye.png")
                else:
                    self.btn_toggle_settings.setText("Hide  ")
                    path = get_resource_path("hideeye.png") if hovering else get_resource_path("showeye.png")
